...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "How long is the wait at Kestrel Commons during the lunch rush?", "expects": "20"},
    {"question": "How late is it noisy in Morrow House on weekends, and are there enforced quiet hours?", "expects": "1am"},
